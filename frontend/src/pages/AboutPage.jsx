...
export default function AboutPage() {
  React.useEffect(() => {
    document.title = 'About Us | Christ-Like Missionaries'

    const description =
      'Learn about Christ-Like Missionaries, a Christian mission group dedicated to proclaiming the Gospel, making disciples, nurturing spiritual growth, and serving communities with Christ-like love.'
    ...
    canonical.setAttribute(
      'href',
      'https://christ-likemissionaries.org/about'
    )
  }, [])
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          <h1 className="text-4xl font-bold text-white mb-6">
            About Christ-Like Missionaries
          </h1>
          ...
          <p className="text-lg text-navy-100 leading-relaxed mb-6">
            Christ-Like Missionaries is a gospel mission group dedicated to
            reflecting the life, character, and teaching of Jesus Christ.
            We exist to proclaim the saving gospel, nurture believers into
            spiritual maturity, and serve communities with compassion and
            humility.
          </p>

          <p className="text-lg text-navy-100 leading-relaxed">
            We believe that every believer is called to live a Christ-Like
            life — loving God, loving people, and serving the world faithfully.
          </p>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gradient-to-br from-navy-500 to-navy-600 p-8 rounded-lg border-l-4 border-gold shadow-lg">
            ...
            <p className="text-navy-100 leading-relaxed">
              To raise Christ-Like believers who impact the world with faith,
        ...
        <section className="bg-gradient-to-r from-navy-700 to-navy-800 text-white p-8 rounded-lg border-b border-navy-300 shadow-lg">
          ...
          <p className="text-lg mb-6 leading-relaxed text-navy-100">
            We believe in Jesus Christ as Lord and Savior, the authority of
            the Holy Scriptures, salvation by grace through faith, and the
            power of the Holy Spirit to transform lives.
          </p>
          ...
          <div className="bg-navy-600 bg-opacity-60 p-6 rounded border-l-4 border-gold">
            ...
            <p className="text-right mt-2 text-navy-200">
              - Philippians 2:5
            </p>
